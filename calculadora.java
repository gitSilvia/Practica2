...
public void actionPerformed (ActionEvent e) {
    ...
    if (campoTexto.getText().endsWith("")) { 
        // Si el campo de texto está vacío, establezca la etiqueta en e
        etiqueta.setText("");
    }
    } else if (source == buttonCero) { 
        // Si se presiona el botón cero, agregue un cero al campo de texto
        if (campoTexto.getText().equals("0")) { // Si el campo de texto es e, no hagas nada.
        return;
    } else { 
        // Si el campo de texto no está vacío, agregue un cero al campo de texto
